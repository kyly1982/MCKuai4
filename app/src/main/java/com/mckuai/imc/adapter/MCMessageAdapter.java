...
public class MCMessageAdapter extends BaseAdapter
{
	...
	private void init(Context context)
	{
		...
		mCircle = MCKuai4.getInstance().getCircleOption();
	...
	private View handleSysMsg(MCMessage msg, View convertView, ViewGroup parent)
	{
		...
		if (null == convertView)
		{
			convertView = mInflater.inflate(R.layout.mckuai_item_message_system, parent, false);
	...
	private View handleAtMsg(MCMessage msg, View convertView, ViewGroup parent)
	{
		...
		if (null == convertView)
		{
			convertView = mInflater.inflate(R.layout.mckuai_item_message_at, parent, false);
	...
	private View handleReplyMsg(MCMessage msg, View convertView, ViewGroup parent)
	{
		...
		if (null == convertView)
		{
			convertView = mInflater.inflate(R.layout.mckuai_item_message_reply, parent, false);
