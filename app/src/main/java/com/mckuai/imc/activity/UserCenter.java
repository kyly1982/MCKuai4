...
//    private com.umeng.socialize.controller.UMSocialService mShareService;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mckuai_activity_user_center);
        application = MCKuai4.getInstance();
...
//                        cancleLodingToast(true);
                        if (mDynamicBean.getData().isEmpty()) {
                            if (application.user.getId() == user.getId()) {
...
//                mShareService.openShare(this, false);
            ...
            case R.id.tv_UserLocation:
                ...
                if (application.isLogin() && user.getId() == application.user.getId()) {
    ...
    private void attentionUser() {
        if (application.isLogin()) {
            ...
            params.put("ownerId", application.user.getId());
...
//		cancleLodingToast(false);
    ...
    private void sendReply(String context) {
        RequestParams params = new RequestParams();
        params.put("loginId", application.user.getId());
