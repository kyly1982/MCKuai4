...
public class CircleImageView extends ImageView
{
	...
	{
		TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.UserCover);
		if (null != a)
		{
			mBorderThickness = a.getDimensionPixelSize(R.styleable.UserCover_border_width, 0);
			mBorderOutsideColor = a.getColor(R.styleable.UserCover_progress_color, defaultColor);
			mBorderInsideColor = a.getColor(R.styleable.UserCover_border_color, defaultColor);
			mTextSize = a.getDimension(R.styleable.UserCover_text_size, 0);
			mStart = a.getInteger(R.styleable.UserCover_start_point, -90);// 默认是从上方开始
			mTextColor = a.getColor(R.styleable.UserCover_text_color, mTextColor);
			a.recycle();
		}
	}
